    ...
    namespace simulation
    {
        namespace stage
        {
                ...
                struct CallColliders
                {
                        ...
                        uint32_t const& currentStep)
                    {
                        (particles::fusion::CallCollider<
                             pmacc::mp_at_c<particles::fusion::FusionPipeline, I>,
            ...
            void Fusion::operator()(MappingDesc const cellDescription, uint32_t const currentStep) const
            {
                ...
                //  here for each particle we need to set multimask to 1 because the particles created by fusion are disabled to not participate in fusion after they were already created.
                // code loading...
            }
